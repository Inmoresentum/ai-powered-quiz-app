...
export default function Hero() {
    return (
        <div className="text-white">
            <div
                className="md:relative md:z-10 max-w-[860px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
                ...
                <div className="z-10 flex justify-center items-center">
                    <p className="md:text-5xl sm:text-4xl text-xl font-bold py-4 w-full text-blue-500">
