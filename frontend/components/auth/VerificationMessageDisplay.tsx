...
type verificationMessageDisplayProps = {
    message: string,
    isError: boolean
}
        ...
        <div
            ...
            <div
                ...
                <Link to="/" className="flex flex-row items-center justify-center">
                    <img
                        src="../../../src/main/resources/META-INF/resources/images/ai_quiz_logo.png"
                        alt="icons/icon.png"
                ...
                {isError ? (
                        <div
                            className="m-6 text-4xl text-red-500 uppercase bg-gray-300 w-full text-center rounded-full font-sans">
                            {message}
                        </div>
                    )
                    : (
