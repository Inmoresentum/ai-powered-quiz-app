    ...
    return (
        <CookieConsent
            ...
            containerClasses="bg-white
             ...
             bottom-0 left-0 right-0 z-50 max-w-screen-lg mx-auto rounded-3xl shadow-2xl"
        ...
        <strong>Welcome to Our Website!</strong> This website uses cookies to enhance the user experience.
                    ...
                    in <Link to={"privacy-policy"}
                             className="text-orange-700 hover:text-green-600 hover:font-semibold
