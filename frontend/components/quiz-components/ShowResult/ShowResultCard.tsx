import ResultCardContinueButton from "../ShowResult/ResultCardButton";


export default function ShowResultCard({QuestionSummary, quizId}: any) {
                    ...
                    <div className="grid-flow">
                        <div className="summary-item"
                            ...
                            <div className="flex-group">
                                <svg className="summary-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                     fill="none"
                                     viewBox="0 0 20 20">
